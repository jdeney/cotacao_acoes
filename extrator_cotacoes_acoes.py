...
#responsabilidade, e lembre-se de dar crédito ao www.fundamentus.com.br
...
# Options
parser = argparse.ArgumentParser(description='Extrator de dados de Cotaçoes de tickers a partir do fundamentus.com.br.')
parser.add_argument('-v', '--version', action='version', version=f'%(prog)s {VERSION}')
parser.add_argument('-o', '--output', help='Especifique o nome de saíde do seu arquivo. O Default é fundamentus_tickers.csv.', default='fundsexplorer_ranking.csv')
...
tickers = pd.read_html(table.get_attribute('outerHTML'), encoding='utf-8', decimal=".", thousands='.')[0]
